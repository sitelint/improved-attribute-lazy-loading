...
const config = {
  input: 'src/improved-attribute-lazy-loading.ts',
  output: [
    {
      file: './dist/improved-attribute-lazy-loading.js',
      format: 'umd',
      name: 'sitelint'
    },
    {
      file: './dist/improved-attribute-lazy-loading.mjs',
      format: 'es'
    }
  ],
  plugins: [
...
const tsDeclarationsConfig = {
  input: './src/improved-attribute-lazy-loading.ts',
  output: [{
    file: 'dist/improved-attribute-lazy-loading.d.ts',
    format: 'es'
  }],
  plugins: [
    dts()
